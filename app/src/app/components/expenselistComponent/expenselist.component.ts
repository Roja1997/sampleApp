...
export class expenselistComponent extends NBaseComponent implements OnInit {
    ...
    values;
    imagePath;
    constructor(private route:ActivatedRoute,public pubsub:NPubSubService,private mService:mailService, private otrdetailService: otrdetailService,private bdms: NDataModelService,private router:Router,private localStorage:NLocalStorageService) {
        super();
